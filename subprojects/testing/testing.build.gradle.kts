...
val coreTestDescription =
    "Limited support Kotlin Multiplatform test library which will be deprecated if officially supported (kotlinx-coroutines, and MockK)"
    ...
    publishing {
        ...
        publications.withType<MavenPublication>().all {
            ...
            pom {
                ...
                description.set(coreTestDescription)
